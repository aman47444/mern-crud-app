...
export default function Pagination(props) {
    ...
    const { data, Component, nextButton, prevButton, selectPage, page, pages, limit, handleDelete, handleEdit, isFetch, handleView } = props
    const getId = (id) => {
        handleDelete(id)
    }
    ...
    return (
        <div>
            <div className="d-flex justify-content-end"><Link to="/create" className="createUser">Create User</Link></div>
            <div className="dataContainer mt-3">
                <Component data={data} getId={getId} handleEdit={handleEdit} handleView={handleView} />
            </div>
